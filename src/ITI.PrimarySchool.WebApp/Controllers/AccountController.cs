...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLogin( [FromQuery] string provider )
        {
            ...
            if( await _authenticationSchemeProvider.GetSchemeAsync( provider ) == null ) return BadRequest();
        ...
        private async Task SignIn( string email, string userId )
        {
            ...
            ClaimsIdentity identity = new ClaimsIdentity( claims, CookieAuthentication.AuthenticationType,
