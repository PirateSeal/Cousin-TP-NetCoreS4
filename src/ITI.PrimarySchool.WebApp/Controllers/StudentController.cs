...
namespace ITI.PrimarySchool.WebApp.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        {
            var result = await _studentGateway.GetAll();
            return Ok( result );
        }
        ...
        {
            var result = await _studentGateway.FindById( id );
        ...
        {
            var result =
                await _studentGateway.Create( model.FirstName, model.LastName, model.BirthDate, model.GitHubLogin,
                    model.ClassId );
        ...
        {
            Result result = await _studentGateway.Update( id, model.FirstName, model.LastName, model.BirthDate,
                model.GitHubLogin, model.ClassId );
            return this.CreateResult( result );
        }
