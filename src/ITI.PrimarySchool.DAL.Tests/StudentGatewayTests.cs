...
namespace ITI.PrimarySchool.DAL.Tests
{
    ...
    public class StudentGatewayTests
    {
        ...
        private void CheckStudent( Result<StudentData> student, string firstName, string lastName, DateTime birthDate )
        {
        ...
        private void CheckStudent( Result<StudentClassData> studentClass, string firstName, string lastName,
            DateTime birthDate, int classId )
        {
        ...
        public async Task can_assign_class()
        {
            ...
            var studentResult = await sut.Create( firstName, lastName, birthDate, 0 );
            ...
            int classId1;
            {
                ...
                var classResult = await classGateway.Create( className, level );
                ...
                var studentClass = await sut.FindStudentClassById( studentId );
        ...
        public async Task can_create_find_update_and_delete_student()
        {
...

            {
                ...
                Result r = await sut.Update( studentId, firstName, lastName, birthDate, null, studentId );
